...
if useHex:
    ...
    if structured:
        ...
        refined_L=[plate_dim[1]/4,  plate_dim[1]/2.1]
        vertices = [[0.0, 0.0],  #0
                    [L[0], 0.0], #1
                    [L[0], L[1]-cubic_hole_dim[1]], #2
                    [L[0]-cubic_hole_dim[0], L[1]-cubic_hole_dim[1]], #3
                    [L[0]-cubic_hole_dim[0], L[1]], #4
                    [0.0, L[1]], #5
        ...
        regions = [ [0.01,0.01],
                    ...
                    # [cubic_hole_center[0],cubic_hole_center[1]],
                   ]
        regionFlags = [1,
                       2,
                    #    3
